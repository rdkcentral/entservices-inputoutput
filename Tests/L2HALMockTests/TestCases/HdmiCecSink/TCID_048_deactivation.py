...
curl_response = Utils.send_curl_command(HdmiCecSinkApis.deactivate_command)
if curl_response:
...
# send the curl command and fetch the output json response
curl_response = Utils.send_curl_command(HdmiCecSinkApis.activate_command)
if curl_response:
...
tc_id = 'TCID048_coverage enhancements'
