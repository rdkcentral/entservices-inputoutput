"""
TCID005 - Scenario: WPS Full Lifecycle
Verify that the LED correctly transitions through the full WPS flow:
  WPS_CONNECTING -> WPS_CONNECTED -> ACTIVE (post-connect)
"""
import json
import time
import sys
...
def run_test():
    log_info("TCID005 - Scenario: WPS Full Lifecycle (CONNECTING -> CONNECTED -> ACTIVE)")
    steps = [
