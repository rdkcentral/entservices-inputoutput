"""
TCID008 - Scenario: Factory Reset Sequence
Verify FULL_SYSTEM_RESET (FACTORY_RESET) is reported by MW and device returns to STANDBY.
  ACTIVE -> FACTORY_RESET -> STANDBY
"""
import json
import time
import sys
...
def run_test():
    log_info("TCID008 - Scenario: Factory Reset Sequence")
    log_info("  ACTIVE -> FACTORY_RESET -> STANDBY")
    steps = [
        ("indicator_set_state_active.yaml",        "ACTIVE"),
        ("indicator_set_state_factory_reset.yaml", "FACTORY_RESET"),
